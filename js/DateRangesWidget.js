    ...
    var internal = {
        ...
        createElements: function($target) {
            ...
            if (!$dropdown) {
                $dropdown = $(
                  ...
                  'Aggregation:' +
                  '<select class="form-control input-sm aggregation">' +
                  '</select>' +
									'<div class="btn-group" role="group" aria-label="Aggregation"><button type="button" class="btn btn-default">Left</button><button type="button" class="btn btn-default">Middle</button><button type="button" class="btn btn-default">Right</button></div>'+
									'</div>' +
                  '<div class="main-daterange">' +
                  '<div>' +
                  'Date Range:' +
                  '<select class="form-control input-sm daterange-preset">' +
                  '</select>' +
                  '<span class="parameters">' +
                  '<input type="number" class="form-control input-sm daterange-preset-parameter1" />' +
                  '</span>' +
                  '</div>' +
									'<div class="form-group">' +
								    '<label class="sr-only" for="exampleInputAmount">Amount (in dollars)</label>' +
								    '<div class="input-group">' +
								      '<input type="text" class="form-control input-sm dr dr1 from" lastSel="0" />' +
								      '<div class="input-group-addon">-</div>' +
								      '<input type="text" class="form-control input-sm dr dr1 to" lastSel="1" />' +
								  	'</div>' +
							  	'</div>' +
                  '<input type="hidden" class="form-control input-sm dr dr1 from_millis" lastSel="2" /><input type="hidden" class="dr dr1 to_millis" lastSel="3" />' +
                  '</div>' +
                  '<div>' +
                  '<input type="checkbox" checked="checked" class="enable-comparison" /> Compare to:' +
                  '<select class="form-control input-sm comparison-preset">' +
                  ...
                  '<div class="comparison-daterange">' +
								    ...
								    '<label class="sr-only" for="exampleInputAmount">Amount (in dollars)</label>' +
								    '<div class="input-group">' +
								      '<input type="text" class="form-control input-sm dr dr2 from" lastSel="2" />' +
								      '<div class="input-group-addon">-</div>' +
								      '<input type="text" class="form-control input-sm dr dr2 to" lastSel="3" />' +
								  	'</div>' +
							  	'</div>' +
                  '<input type="hidden" class="dr dr2 from_millis" lastSel="2" /><input type="hidden" class="dr dr2 to_millis" lastSel="3" />' +
                  '</div>' +
                  '<p class="text-right">' +
										'<button class="btn btn-link btn-small" id="button-cancel">Cancel</button>' +
                    '<button class="btn btn-success btn-small" id="button-ok">Apply</button>' +
                  '</p>' +
                  '</div>' +
                  '</div>');
        ...
        updateDateField: function($target) {
            ...
            if (values.dr1from && values.dr1to) {
                ...
                $('span.main', $target).text('Select date');
            }
        ...
        expandDropdown: function($target) {
            ...
            // $('.date-range-field', $target).css({
            //     borderBottomLeftRadius: 0,
            //     borderBottomRightRadius: 0
            // });
            // $('.date-range-field a', $target).css({
            //     borderBottomRightRadius: 0
            // });
